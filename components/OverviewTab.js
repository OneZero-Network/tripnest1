...
import { StatHero, Card, SectionHeader, currencySymbol, useTheme } from './UI';
...
export default function OverviewTab({ finance, timeline, today, tripName, navigation, onOpenSettlement }) {
...
const makeStyles = (theme) => StyleSheet.create({
  ...
  miniStat: { flex: 1, backgroundColor: theme.surface, borderRadius: theme.radius.lg, borderWidth: 1, borderColor: theme.line, padding: theme.space.sm },
